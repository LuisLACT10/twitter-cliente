        ...
        etValue.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if(count > MAX_TWEET_LENGTH){
                    ...
                    //tvCount.text.setTextColor(Color.Red);
                }else{
                    btnTweet.setEnabled(true);
                    tvCount.setTextColor(Color.parseColor("#616161"));
                }
                tvCount.setText(Integer.toString(count)+"/"+Integer.toString(MAX_TWEET_LENGTH));
